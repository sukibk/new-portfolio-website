...
const AboutText = () => {
  ...
  return (
    <article className="flex-1 px-6 py-10 md:py-16  rounded-xl bg-background backdrop-blur-md shadow-xl transition-colors duration-500">
      <ScrollWrapper>
      ...
      <ScrollWrapper className="text-foreground-text font-code text-base md:text-lg leading-relaxed space-y-4 transition-colors duration-500">
        <p>
          ...
          bold ideas into seamless digital experiences. From React to Node.js, I
