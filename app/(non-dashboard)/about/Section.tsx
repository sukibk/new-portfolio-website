...
const AboutPage = () => {
  return (
    ...
    >
      ...
      <AboutGraphics />
      <img
        className="absolute top-200 sm:top-150 md:top-120 lg:bottom-0 -right-40 -z-10 opacity-10 dark:opacity-30 rotate-150 nav:right-0 nav:bottom-0 transition-all duration-500"
